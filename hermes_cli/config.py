...
OPTIONAL_ENV_VARS = {
    ...
    "SAAS_WEB_ENABLED": {
        "description": "Enable the SaaS web platform adapter for private backend-to-Hermes messaging.",
        "prompt": "Enable SaaS web adapter (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SAAS_WEB_KEY": {
        "description": "Bearer token required from the SaaS backend when calling the SaaS web adapter.",
        "prompt": "SaaS web adapter auth key",
        "url": None,
        "password": True,
        "category": "messaging",
        "advanced": True,
    ...
    "SAAS_WEB_PORT": {
        "description": "Port for the SaaS web adapter (default: 8652).",
        "prompt": "SaaS web adapter port",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SAAS_WEB_HOST": {
        "description": "Host/bind address for the SaaS web adapter (default: 127.0.0.1). Use a private interface or loopback in production.",
        "prompt": "SaaS web adapter host",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "SAAS_WEB_CALLBACK_URL": {
        "description": "Backend callback URL that receives assistant messages and typing events from the SaaS web adapter.",
        "prompt": "SaaS backend callback URL",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    },
    "SAAS_WEB_CALLBACK_KEY": {
        "description": "Bearer token sent by the SaaS web adapter to authenticate callback deliveries. Defaults to SAAS_WEB_KEY.",
        "prompt": "SaaS callback auth key",
        "url": None,
        "password": True,
        "category": "messaging",
        "advanced": True,
    ...
    "SAAS_WEB_USER_ID": {
        "description": "Default SaaS user ID for this Hermes profile when inbound messages omit user_id.",
        "prompt": "Default SaaS user ID",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "SAAS_WEB_USER_NAME": {
        "description": "Default SaaS user display name for this Hermes profile when inbound messages omit user_name.",
        "prompt": "Default SaaS user name",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
